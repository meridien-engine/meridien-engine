...
*   For frontend monorepo workspace setups, directories, and the platform admin control plane, see [docs/frontend_bootstrap_plan.md](file:///media/muhammad/FS/2026/meridien-engine/docs/frontend_bootstrap_plan.md).
